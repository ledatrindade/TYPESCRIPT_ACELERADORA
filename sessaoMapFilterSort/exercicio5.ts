...
const alunas = [
    ...
    const maiorMedia = alunas.reduce((parametroValorAtual, parametroMaiorValor) => {
        ...
        const mediasolicitada = (parametroMaiorValor.prova.p1 + parametroMaiorValor.prova.p2 + parametroMaiorValor.prova.p3) /3;
           return parametroMaiorValor > parametroValorAtual ? parametroMaiorValor : parametroValorAtual
    });
    console.log(maiorMedia.nome);
